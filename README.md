...
when the files are parsed. To include them in the database, add the custom field to ```resources/specification.json``` following the conventions of the other fields.
